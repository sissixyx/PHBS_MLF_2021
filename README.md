...
2. Violatility of raw materials price: besides what have been listed in the features list, we also calculate the wow return for each raw materials as the input. 
